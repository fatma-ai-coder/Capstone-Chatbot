...
// Import the ChatbotPage2
import 'Chatbot2.dart'; // Make sure this path matches where your ChatbotPage2 is defined

void main() {
  runApp(
    MaterialApp(debugShowCheckedModeBanner: false, home: BasicLoginScreen2()),
  );
}

class BasicLoginScreen2 extends StatefulWidget {
  const BasicLoginScreen2({super.key});

  @override
  _BasicLoginScreenState createState() => _BasicLoginScreenState();
}

class _BasicLoginScreenState extends State<BasicLoginScreen2> {
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            if (_usernameController.text == "dah" &&
                              ...
                              // Navigate to ChatbotPage2
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ChatbotPage2(),
                                ),
                              );
                            } else {
                              ScaffoldMessenger.of(context).showSnackBar(
